...
GameSnapshot resultSnapshot({
  ...
  GemType? pendingRewardGem,
  GridPoint? rewardReplacementPoint,
  String? selectedTurretName,
  List<GemType?> selectedTurretGems = const [],
  int selectedTurretLevel = 0,
  int selectedTurretSlotLimit = 0,
  ...
  return GameSnapshot(
    ...
    pendingRewardGem: pendingRewardGem,
    rewardReplacementPoint: rewardReplacementPoint,
    ...
    selectedTurretName: selectedTurretName,
    selectedTurretGems: selectedTurretGems,
    selectedTurretGemSlotIndex: null,
    selectedTurretSlotLimit: selectedTurretSlotLimit,
    ...
    selectedTurretLevel: selectedTurretLevel,
