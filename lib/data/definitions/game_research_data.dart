...
const gameResearchDefinitions = {
  ...
  ResearchType.criticalChance: ResearchDefinition(
    type: ResearchType.criticalChance,
    maxLevel: 10,
    requiredClearedStage: 4,
    baseRuneCost: 70,
    costMultiplier: 1.2,
    legacyCostLevelsPerRank: 2,
    durationMillis: halfHourResearchDurationMillis,
    durationMultiplier: 1.1,
  ),
  ResearchType.emergencySale: ResearchDefinition(
    type: ResearchType.emergencySale,
    maxLevel: 5,
    requiredClearedStage: 1,
    baseRuneCost: 80,
    costMultiplier: 1,
    runeCosts: [80, 120, 180, 260, 360],
    durationMillis: halfHourResearchDurationMillis,
    durationMultiplier: 1.1,
  ),
