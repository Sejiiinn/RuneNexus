...
const gameGems = <GemType, GemDefinition>{
  ...
  GemType.multipleProjectiles: GemDefinition(
    type: GemType.multipleProjectiles,
    name: '다중 투사체',
    shortText: '투사체 +2 · 피해 50% 감폭',
    effectType: GemEffectType.additionalProjectiles,
    value: 2,
    color: Color(0xFF79E6C4),
