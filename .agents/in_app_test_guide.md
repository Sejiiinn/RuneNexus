...
챕터 2(스테이지 6~10)는 [균열 타일·환경 3종의 제작·적용 기준](../design/chapter2_3d/README.md)을 함께 확인한다. 실제 길·건설칸·포탈·코어 위치를 유지하고, 장식이 이동·건설을 가리지 않는지 고정/드론 시점에서 확인한다. 1장 복귀와 스테이지 16 이후의 기존 2D 전환도 변경 영향에 맞게 검사한다. Android 이외 플랫폼은 기존 전장을 유지한다.
