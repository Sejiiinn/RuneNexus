...
var failures := []
var checks := 0
var out := "/Users/sejin/Documents/Codex/RuneNexus/design/combat_ui_concepts/2026-09-22/turret-actions/native/strict-audit/"
...
func run():
	...
	check(hud.tab=="gems" and hud.body.find_child("BuyGemSlot",true,false)!=null,"mouse gems tab")
	...
	var result := {"checks":checks,"failures":failures,"renderer":RenderingServer.get_current_rendering_method(),"user_dir":OS.get_user_data_dir()}
