...
var app
var hud
var out := "/Users/sejin/Documents/Codex/RuneNexus/design/combat_ui_concepts/2026-09-22/turret-actions/native/"
...
func run() -> void:
	...
	turret.type = "lightning"; turret.primaryTrait = null; turret.secondaryTrait = null
	hud.tab = "stats"; hud.body_key = ""
	await capture("lightning-320")
	quit()
