...
현재 게임용 모델은 [2026-09-26 경량 적용](../optimized-game-distance/README.md)을 따른다. [2026-09-22 전체 90% 축소](../scale-90/README.md)의 크기·계층·부착점은 유지한다. 아래 초기 이관 기록은 고해상도 원본의 형상·재질 보존 근거다.
