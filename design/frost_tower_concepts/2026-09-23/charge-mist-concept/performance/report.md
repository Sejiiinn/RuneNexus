...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| mist_0 | 6.942–6.943 | 0.182–0.198 | 미측정 | 0.010–0.011 | 56.000–56.000 | 71501.000–71501.000 |
| mist_1 | 6.914–6.937 | 0.393–0.394 | 미측정 | 0.021–0.021 | 57.000–57.000 | 72077.000–72077.000 |
| mist_4_overlap | 6.908–6.953 | 0.357–0.388 | 미측정 | 0.019–0.021 | 60.000–60.000 | 73805.000–73805.000 |
| mist_8_overlap | 6.938–6.939 | 0.229–0.383 | 미측정 | 0.014–0.020 | 64.000–64.000 | 76109.000–76109.000 |
| mist_8_spread | 6.918–6.941 | 0.381–0.385 | 미측정 | 0.020–0.020 | 64.000–64.000 | 76109.000–76109.000 |
| light_off | 6.923–6.926 | 0.389–0.394 | 미측정 | 0.021–0.021 | 56.000–56.000 | 71501.000–71501.000 |
| light_on | 6.931–6.936 | 0.389–0.389 | 미측정 | 0.021–0.021 | 56.000–56.000 | 71501.000–71501.000 |

프레임 간격 꼬리값 (정방향/역방향):

- `mist_0`: p95 [7.394, 7.371], p99 [7.533, 7.606] ms; 864 frames
- `mist_1`: p95 [7.451, 7.551], p99 [7.589, 7.74] ms; 864 frames
- `mist_4_overlap`: p95 [7.569, 7.597], p99 [7.827, 7.722] ms; 864 frames
- `mist_8_overlap`: p95 [7.457, 7.618], p99 [7.708, 7.947] ms; 865 frames
- `mist_8_spread`: p95 [7.526, 7.613], p99 [7.813, 7.82] ms; 864 frames
- `light_off`: p95 [7.452, 7.487], p99 [7.642, 7.713] ms; 865 frames
- `light_on`: p95 [7.505, 7.513], p99 [7.654, 7.609] ms; 864 frames
