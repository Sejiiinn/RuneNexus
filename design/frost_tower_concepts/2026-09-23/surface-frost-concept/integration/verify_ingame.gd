...
var output := "/Users/sejin/Documents/Codex/RuneNexus/design/frost_tower_concepts/2026-09-23/surface-frost-concept/integration/godot"
...
func run() -> void:
	...
	check(OS.get_user_data_dir().contains("RuneNexus-Frost-Surface-Integration"), "isolated user directory")
