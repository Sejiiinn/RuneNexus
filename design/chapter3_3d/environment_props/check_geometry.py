...
report['bore_ray_tests']={'conduit_axis_clear':ray('side_conduit',(-1,-.135,-.25),(1,0,0)),'exhaust_open_depth':ray('exhaust_vent',(0,-.143,.5),(0,0,-1)),'elbow_upward_depth':ray('elbow_pipe',(0,-.215,.5),(0,0,-1))}
assert not report['bore_ray_tests']['conduit_axis_clear']
assert report['bore_ray_tests']['exhaust_open_depth'][0][0]>.5
assert report['bore_ray_tests']['elbow_upward_depth'][0][0]>.4
