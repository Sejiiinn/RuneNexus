...
ROOT=H.parents[3]
ASSET=H/'chapter3-props-optimized.glb'
...
s.cycles.samples=48
s.render.filepath=str(H/'optimized-glb-mounted.png')
bpy.ops.render.render(write_still=True)
(H/'render-check.json').write_text(json.dumps({'glb_sha256':hashlib.sha256(ASSET.read_bytes()).hexdigest(),'image':'optimized-glb-mounted.png','camera':'mounted source hero','views':1,'purpose':'source/export combined representative visual review'},indent=2)+'\n')
