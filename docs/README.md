...
| Flutter 제거·Godot 단일 앱 전환 | [Flutter 제거 실행 로드맵](godot_unified_app_roadmap.md) | [현행 전투 책임](godot_combat_migration_boundaries.md), [1단계 구현 검증](analysis/flutter_host_removal_20260921/README.md), 저장·경제·플랫폼 계약 |
