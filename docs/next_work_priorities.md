...
- 영구 업그레이드는 시작 골드와 넥서스 HP만 있어 장기 성장 선택지가 얕다.
- 보스가 마지막에 등장하도록 정리됐지만, 보스 전용 피드백과 긴장감은 아직 약하다.
...
- 보스가 마지막에 1마리 등장하도록 정리됐지만, 현재는 일반 적의 확장처럼 보일 가능성이 있다.
...
```text
docs/next_work_priorities.md 기준으로 2순위인 영구 업그레이드 확장과 해금 단계 설계를 진행해줘.
```
