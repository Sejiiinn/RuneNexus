...
- 최우선 과제는 챕터 2~3 클리어 보상과 연구 조건 연결이다. 챕터 2는 보호막병, 챕터 3은 장갑/탱커 압축 전장까지 들어갔으므로 이제 반복 동기를 만들어야 한다.
...
```text
docs/next_work_priorities.md 기준으로 최우선 과제인 챕터 2~3 보상과 연구 조건 연결을 진행해줘.
```
